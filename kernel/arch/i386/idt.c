...
void idt_init(void) {
	...
	extern void irq0_handler(struct interrupt_frame* frame);
        ...
        extern void irq2_handler(struct interrupt_frame* frame);
        extern void irq3_handler(struct interrupt_frame* frame);
        extern void irq4_handler(struct interrupt_frame* frame);
        extern void irq5_handler(struct interrupt_frame* frame);
        extern void irq6_handler(struct interrupt_frame* frame);
        extern void irq7_handler(struct interrupt_frame* frame);
        extern void irq8_handler(struct interrupt_frame* frame);
        extern void irq9_handler(struct interrupt_frame* frame);
        extern void irq10_handler(struct interrupt_frame* frame);
        extern void irq11_handler(struct interrupt_frame* frame);
        extern void irq12_handler(struct interrupt_frame* frame);
        extern void irq13_handler(struct interrupt_frame* frame);
        extern void irq14_handler(struct interrupt_frame* frame);
        extern void irq15_handler(struct interrupt_frame* frame);
	*/
